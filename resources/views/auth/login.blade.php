                  ...
                  <div class="card-header pb-0">
                    <div class="app-brand w-100 d-flex justify-content-center border-bottom-0">
                      <a class="w-auto pl-0" href="{{ route('site.home') }}">
                        <img src="{{ asset('assets/general/img/logo.jpg') }}" alt="logo" style="width: 70px; border-radius: 50%">
                      </a>
                    </div>
                  </div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-12 ">
                          <input type="password" name="password" class="form-control input-lg @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="Password" required autocomplete="off">
                          @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
