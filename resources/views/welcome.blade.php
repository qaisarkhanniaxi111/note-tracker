        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light foi-navbar">
                <a class="navbar-brand" href="{{ route('site.home') }}">
                    <img src="{{ asset('assets/site/images/logo.svg') }}" alt="note tracker">
                </a>
            ...
            <div class="header-content">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <a href="{{ route('register') }}" class="btn btn-primary mb-4 text-white">Get Started</a>
                        <div class="my-2">
                            <p class="header-app-download-title">GET OUR MOBILE APP</p>
                        </div>
                        <div>
                            <button class="btn btn-app-download mr-2"><img src="{{ asset('assets/site/images/ios.svg') }}" alt="App store"></button>
                            <button class="btn btn-app-download"><img src="{{ asset('assets/site/images/android.svg') }}" alt="play store"></button>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <img src="{{ asset('assets/site/images/app_1.png') }}" alt="app" width="388px" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="carousel-item active">
                                <div class="d-flex flex-wrap justify-content-center">
                                    <div class="clients-logo">
                                        <img src="{{ asset('assets/site/images/clients/slack.svg') }}" alt="Slack" class="img-fluid">
                                    </div>
                                    <div class="clients-logo">
                                        <img src="{{ asset('assets/site/images/clients/spotify.svg') }}" alt="Spotify" class="img-fluid">
                                    </div>
                                    <div class="clients-logo">
                                        <img src="{{ asset('assets/site/images/clients/paypal.svg') }}" alt="Paypal" class="img-fluid">
                                    </div>
                                    <div class="clients-logo">
                                        <img src="{{ asset('assets/site/images/clients/amazon.svg') }}" alt="Amazon" class="img-fluid">
                                    </div>
                                    <div class="clients-logo">
                                        <img src="{{ asset('assets/site/images/clients/google.svg') }}" alt="Google" class="img-fluid">
                                    </div>
                                    <div class="clients-logo">
                                        <img src="{{ asset('assets/site/images/clients/samsung.svg') }}" alt="Samsung" class="img-fluid">
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-5 mb-md-0">
                    <img src="{{ asset('assets/site/images/app_2.png') }}" alt="special offers" class="img-fluid" width="492px">
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-4 foi-review mb-5 mb-md-0">
                    ...
                    <div class="media foi-review-user">
                        <img src="{{ asset('assets/site/images/avatar/avatar_11.jpg') }}" alt="user" class="avatar">
                        <div class="media-body">
                ...
                <div class="col-md-4 foi-review mb-5 mb-md-0">
                    ...
                    <p class="foi-review-content">Thank you for your very professional and prompt response. I wished I had found you before I spent money on a competitors theme.</p>
                    <div class="media foi-review-user">
                        <img src="{{ asset('assets/site/images/avatar/avatar_12.jpg') }}" alt="user" class="avatar">
                        <div class="media-body">
                ...
                <div class="col-md-4 foi-review mb-5 mb-md-0">
                    ...
                    <p class="foi-review-content">Thank you for your very professional and prompt response. I wished I had found you before I spent money on a competitors theme.</p>
                    <div class="media foi-review-user">
                        <img src="{{ asset('assets/site/images/avatar/avatar_13.jpg') }}" alt="user" class="avatar">
                        <div class="media-body">
        ...
        <div class="container">
            <div class="row footer-content">
                ...
                <div class="col-md-4 col-lg-5 col-xl-6 py-3 py-md-0 d-md-flex align-items-center justify-content-end">
                    <a href="#" class="btn btn-danger btn-lg">Contact form</a>
                </div>
            </div>
            <div class="row footer-widget-area">
                <div class="col-md-3">
                    <div class="py-3">
                        <img src="{{ asset('assets/site/images/logo-white.svg') }}" alt="FOI">
                    </div>
                ...
                <div class="col-md-3 mt-3 mt-md-0">
                    ...
                    <nav class="social-menu">
                        <a href="#!"><img src="{{ asset('assets/site/images/facebook.svg') }}" alt="facebook"></a>
                        <a href="#!"><img src="{{ asset('assets/site/images/instagram.svg') }}" alt="instagram"></a>
                        <a href="#!"><img src="{{ asset('assets/site/images/twitter.svg') }}" alt="twitter"></a>
                        <a href="#!"><img src="{{ asset('assets/site/images/youtube.svg') }}" alt="youtube"></a>
                    </nav>
                </div>
            </div>
        </div>
    </footer>
    <script src="{{ asset('assets/site/vendors/jquery/jquery.min.js') }}"></script>
    <script src="{{ asset('assets/site/vendors/popper.js/popper.min.js') }}"></script>
    <script src="{{ asset('assets/site/vendors/bootstrap/dist/js/bootstrap.min.js') }}"></script>
</body>
